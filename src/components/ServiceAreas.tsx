      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto mb-12">
          {serviceAreas.map((area, index) => (
            <div
              key={index}
              className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all p-6 border-2 border-gray-200 hover:border-secondary-300"
            >
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 max-w-4xl mx-auto border-2 border-gray-200">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <Check className="w-5 h-5 text-secondary-600 flex-shrink-0 mt-1" />
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            <div className="text-center">
              ...
              <a
                href="#contact"
                className="inline-block px-8 py-4 bg-gradient-to-r from-primary-600 to-accent-600 text-white font-bold rounded-xl hover:shadow-xl transition-all"
              >
